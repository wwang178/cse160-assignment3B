...
function addActionsForHtmlUI() {
    ...
    document.getElementById("loadMapWithFloorButton").addEventListener("click", function () {
        g_map = JSON.parse(JSON.stringify(g_mapWithFloor));
        initializeMapCubes();
    });
    document.getElementById("loadMapWithSomeStructuresButton").addEventListener("click", function () {
...
function main() {
    ...
    // generateDefaultMap();
    // g_map = JSON.parse(JSON.stringify(g_mapWithSomeStructures));
    g_map = JSON.parse(JSON.stringify(g_emptyMap));
    initializeMapCubes();
