...
class Vector3 {
    ...
    addNew(other){
      ...
      outVec.elements[0] = this.elements[0] + other.elements[0];
      outVec.elements[1] = this.elements[1] + other.elements[1];
      outVec.elements[2] = this.elements[2] + other.elements[2];
      return outVec;
    }
    subNew(other){
      let outVec = new Vector3();
    ...
    divNew(scalar){
      let outVec = new Vector3();
      outVec.elements[0] = this.elements[0] / scalar;
      outVec.elements[1] = this.elements[1] / scalar;
      outVec.elements[2] = this.elements[2] / scalar;
      return outVec;
    }
    mulNew(scalar){
      let outVec = new Vector3();
